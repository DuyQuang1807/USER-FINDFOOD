...
public class CartHDCTAdapter1 extends RecyclerView.Adapter<CartHDCTAdapter1.MyViewHolder> {

    ArrayList<Order1> cartList;
    Context context;
    ...
    public CartHDCTAdapter1(ArrayList<Order1> cartList, Context context) {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
        ...
        final Order1 cart = cartList.get(position);

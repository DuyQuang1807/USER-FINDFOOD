...
public class CartAdapterSoLuongMon extends RecyclerView.Adapter<CartAdapterSoLuongMon.MyViewHolder> {
    ...
    public CartAdapterSoLuongMon(ArrayList<Order> cartList, Context context) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
        ...
        itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.row_card_thanh_toan, parent, false);

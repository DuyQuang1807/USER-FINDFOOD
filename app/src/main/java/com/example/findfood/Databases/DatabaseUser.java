...
public class DatabaseUser {
    ...
    public void insert(User item){
        ...
        User usertest = new User(item.getEmail(), item.getPassword(), item.getName(), item.getPhone(), item.getImage(), item.getDiachi(), item.getNgaySinh(), item.getGioiTinh(), item.getToken(), item.getTrangThai());
        mRef.child(item.getToken()).setValue(usertest).addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
